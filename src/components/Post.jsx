...
function Post({ post = { id: -1, title: "This is default post title", content: "This is default post content" }, deletePost }) {
    ...
    return (
        ...
        <Card className='border-0 shadow-sm mt-3' style={{textAlign: 'center', color: '#1d2b64', marginBottom: '20px', fontFamily: 'Poppins, sans-serif' ,maxWidth: '1200px', width: '90%', background: 'rgba(255, 255, 255, 0.8)', padding: '10px', boxShadow: '0 10px 30px rgba(0, 0, 0, 0.1)', borderRadius: '15px', transition: 'transform 0.3s' }}>
            <CardBody>
                <h3>{post.title}</h3>
